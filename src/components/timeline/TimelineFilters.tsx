  ...
  return (
    <div className="grid grid-cols-1 items-start gap-3 md:grid-cols-[minmax(0,1fr)_auto]">
      ...
      <button
        ...
        className="inline-flex min-h-9 w-full cursor-not-allowed items-center justify-between gap-2 self-start rounded-full border border-dashed border-border px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.15em] text-muted-foreground opacity-80 md:w-auto md:justify-start"
      >
