export const es = {
  ...
  checkTimeline: "Explorar mi trayectoria",
  downloadResume: "Descargar mi currículum",

  selectCategory: "Selecciona una categoría...",
  selectTech: "Selecciona una tecnología...",
  ...
  loadMore: "Cargar más",
  statusOutdated: "Este proyecto necesita una actualización.",
  ...
  project_finace_subject: "Aplicación de Finanzas Personales",
  project_finace_description:
    "Aplicación web para la gestión y análisis financiero. Permite a los usuarios hacer un seguimiento de ingresos y gastos a lo largo del tiempo, proporcionando herramientas de análisis detallado y visualización de datos financieros.",
  project_wordlechain_subject: "Juego Wordle (Edición Blockchain)",
  project_wordlechain_description:
    "Wordlechain es una versión en blockchain del clásico juego Wordle, diseñada para Web3. Los jugadores utilizan un token ERC20 personalizado para realizar intentos, combinando tecnología blockchain con una interfaz web interactiva.",
